...
Shader "Tessellation/Tess_Standard"
{
	Properties
	{
        ...
        _Displacement ("Displacement", Range(0, 1000.0)) = 0.3
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "debug/UnityStandardMetaMod.cginc"
			ENDCG
		}
	}
